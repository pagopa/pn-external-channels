...
@NoArgsConstructor
@AllArgsConstructor
public class PnExtChnCartEventPayloadReceiver {
    ...
    @NotNull
    @NotEmpty
    @JsonProperty(PnExtChnCartEventPayloadReceiver.PN_EXTCHN_CART_EVENT_DESTINATARIO)
    private String destinatario;

    @JsonProperty(PnExtChnCartEventPayloadReceiver.PN_EXTCHN_CART_EVENT_CODICE_FISCALE)
    private String codiceFiscale;

    //

    @JsonProperty(PnExtChnCartEventPayloadReceiver.PN_EXTCHN_CART_EVENT_PRESSO)
    private String presso;

    @NotNull
    @NotEmpty
    @JsonProperty(PnExtChnCartEventPayloadReceiver.PN_EXTCHN_CART_EVENT_INDIRIZZO)
    private String indirizzo;

    @JsonProperty(PnExtChnCartEventPayloadReceiver.PN_EXTCHN_CART_EVENT_SPECIFICA_INDIRIZZO)
    private String specificaIndirizzo;

    @NotNull
    @NotEmpty
    @JsonProperty(PnExtChnCartEventPayloadReceiver.PN_EXTCHN_CART_EVENT_CAP)
    private String cap;

    @NotNull
    @NotEmpty
    @JsonProperty(PnExtChnCartEventPayloadReceiver.PN_EXTCHN_CART_EVENT_COMUNE)
    private String comune;

    @NotNull
    @NotEmpty
    @JsonProperty(PnExtChnCartEventPayloadReceiver.PN_EXTCHN_CART_EVENT_PROVINCIA)
